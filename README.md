...
* Cleaning - Dublicates, rides with duration less than a minute or longer than a 24h and null values are removed also adding 3 more columns **ride_length_mins** for duration of the trip, **day_of_week** and **month** are added. Process [here](https://github.com/Aurimas-N/Cyclist-Bike-share-Analysis/blob/4cbbd89066b61295bef09407de9d58886e90616a/data_cleaning.sql)
